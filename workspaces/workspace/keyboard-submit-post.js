// Keyboard submit post script - uses Ctrl+Enter instead of clicking button
...
(async () => {
  ...
  try {
    console.log('Starting keyboard-submit cookie-based posting...');
    ...
    console.log('Clicking tweet compositor...');
    ...
    // Submit using Ctrl+Enter (keyboard shortcut) instead of clicking button
    // This avoids overlay interception issues
